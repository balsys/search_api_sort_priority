 ...
 * @SearchApiProcessor(
 *   id = "mediabundle",
 *   label = @Translation("Sort Priority by Media Bundle"),
 *   description = @Translation("Sort Priority by Media Bundle."),
 *   stages = {
 *     "add_properties" = 20,
 *     "pre_index_save" = 0,
 *   },
 ...
 * )
 */
class MediaBundle extends ProcessorPluginBase implements PluginFormInterface {
  ...
  public function getPropertyDefinitions(DatasourceInterface $datasource = NULL) {
    ...
    if (!$datasource) {
      $definition = [
        ...
        'label' => $this->t('Sort Priority by Media Bundle'),
        // TODO Come up with better description.
        'description' => $this->t('Sort Priority by Media Bundle.'),
        'type' => 'integer',
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    $parent_name = 'processors[mediabundle][settings]';
