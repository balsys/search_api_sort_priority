 ...
 * @SearchApiProcessor(
 *   id = "paragraphbundle",
 *   label = @Translation("Sort Priority by Paragraph Bundle"),
 *   description = @Translation("Sort Priority by Paragraph Bundle."),
 *   stages = {
 *     "add_properties" = 20,
 *     "pre_index_save" = 0,
 *   },
 ...
 * )
 */
class ParagraphBundle extends ProcessorPluginBase implements PluginFormInterface {

  use PluginFormTrait;

  protected $targetFieldId = 'paragraphbundle_weight';

  /**
   * Can only be enabled for an index that indexes the paragraph bundle entity.
   *
   * {@inheritdoc}
   */
  ...
  public function getPropertyDefinitions(DatasourceInterface $datasource = NULL) {
    ...
    if (!$datasource) {
      $definition = [
        ...
        'label' => $this->t('Sort Priority by Paragraph bundle'),
        // TODO Come up with better description.
        'description' => $this->t('Sort Priority by Paragraph Bundle.'),
        'type' => 'integer',
  ...
  public function addFieldValues(ItemInterface $item) {
    ...
    if ($item->getDatasource()->getEntityTypeId() == 'paragraph') {
